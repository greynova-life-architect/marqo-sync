"""Codex indexing functionality for the sync service with specialized logic."""
import os
import logging
...
class CodexIndexer:
    """Specialized indexer for Codex (folder structure) content."""
    ...
    def set_project_context(self, project_id: str, project_path: str) -> None:
        self.current_project_id = project_id
        self.current_project_path = project_path
        logger.info(f"Set codex project context: {project_id} -> {project_path}")
